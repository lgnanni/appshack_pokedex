...
data class EvolutionDetails(
    ...
    @SerializedName("party_species") val partySpecies: String?,
    @SerializedName("party_type") val partyType: String?,
    @SerializedName("relative_physical_stats") val relPhysStats: String?,
    @SerializedName("time_of_day") val timeOfDay: String,
    @SerializedName("trade_species") val tradeSpecies: String?,
